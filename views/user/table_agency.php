...
<form class="form-horizontal" action="<?php echo base_url('agency'); ?>" method="post">
...
<div class="row mt-3 mb-1">
    ...
    <div class="col-md-1">
        <div class="">
            <a href="<?php echo base_url('agency'); ?>" class="btn btn-info form-control"><i class="ti-reload"></i></a>
        </div>
    </div>
    <div class="col-md-1">
        <div class="text-center">
            <a href="<?php echo base_url('agency'); ?>" class="btn btn-primary form-control">All</a>
        </div>
    </div>
</div>
