	...
	<div class="row">
		...
		<div class="col-md-2 mb-2">
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="" name="invoice_no" id="" value="<?php if(!empty($order_info)){ echo $order_info['invoice_no'];}?>"> 
			</div>
		</div>
		    ...
		    <div class="append_divs col-md-12 mb-12 row">
		        <div class="col-md-2 mb-2">
        			<div class="form-group">
						...
						<select name="<?php if(empty($order_info)){ echo 'website[]';}else{ echo 'website';}?>" class='selUser firstoneselect' style='width: 200px;'>
							<?php if(!empty($order_info)){ ?>
							 <option value="<?php echo $order_info['website']; ?>" selected> <?php echo $order_info['website']; ?> </option>
							<?php } ?>
 <option value='0'>- Search Website -</option>
</select>
						 <?php /*<input type="text" autocomplete="off" class="form-control" placeholder="" name="<?php if(!empty($order_info)){ echo 'website';}else{  echo 'website[]';}?>" id="website" value="<?php if(!empty($order_info)){ echo $order_info['website'];}?>"> 
...
<div class="append_it col-md-12 mb-12" style="display:none">
    <div class="append_divs col-md-12 mb-12 row">
        <div class="col-md-2 mb-2">
			<div class="form-group">
				<label>Website <span class="text-danger">*</span></label>
				<select name="<?php if(empty($order_info)){ echo 'website[]';}else{ echo 'website';}?>" class='selUser' style='width: 200px;'>
...
<select name="<?php if(empty($order_info)){ echo 'invoice_status[]';}else{ echo 'invoice_status';}?>" class="form-control">
                         <option value="">Select Type</option>
	<option value="Sent" <?php if(!empty($order_info) && $order_info['invoice_status'] == 'Sent') echo 'selected';?>>Sent</option>
         <option value="Created" <?php if(!empty($order_info) && $order_info['invoice_status'] == 'Created') echo 'selected';?>> Created </option>
