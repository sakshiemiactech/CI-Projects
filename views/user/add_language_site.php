<form action="<?php if(!empty($site_info)){ echo base_url('do-update-language-site/'.$site_info['id']);}else{echo base_url('do-add-language-site');}?>" method="post" class="form-redirect pt-3">
	<div class="row">
		...
		<div class="col-md-4 mb-4">
			<div class="form-group">
				<label>Language (EX: Spanish) <span class="text-danger"></span></label>
				<input type="text" class="form-control" placeholder="Language" name="language" id="language" value="<?php if(!empty($site_info)){ echo $site_info['language']; }?>">
			</div>
		</div>
			<?php /* 
